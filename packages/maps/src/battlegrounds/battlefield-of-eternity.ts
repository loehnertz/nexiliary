 ...
 * starts the clock. That is why the outcome label names it.
 *
...
export const battlefieldOfEternity: MapDefinition = {
  ...
  camps: [
    camp({ id: 'impaler-n', label: 'Impalers north', type: 'siege', bearing: 'n', position: { x: 0.472, y: 0.051 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [40] }),
    camp({ id: 'impaler-s', label: 'Impalers south', type: 'siege', bearing: 's', position: { x: 0.506, y: 0.927 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [40] }),
    camp({ id: 'shaman-w', label: 'Shaman west', type: 'bruiser', bearing: 'w', position: { x: 0.361, y: 0.556 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [35] }),
    camp({ id: 'shaman-e', label: 'Shaman east', type: 'bruiser', bearing: 'e', position: { x: 0.628, y: 0.432 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [35] }),
  ],
}
