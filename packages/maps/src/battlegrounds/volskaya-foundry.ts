...
export const volskayaFoundry: MapDefinition = {
  ...
  camps: [
    camp({ id: 'trooper-w', label: 'Troopers west', type: 'siege', bearing: 'w', position: { x: 0.345, y: 0.315 }, firstSpawnSeconds: 60, respawnSeconds: 105, travelSeconds: [45] }),
    camp({ id: 'trooper-e', label: 'Troopers east', type: 'siege', bearing: 'e', position: { x: 0.655, y: 0.315 }, firstSpawnSeconds: 60, respawnSeconds: 105, travelSeconds: [45] }),
    camp({ id: 'fort-w', label: 'Turret west', type: 'special', bearing: 'w', position: { x: 0.395, y: 0.58 }, firstSpawnSeconds: 60, respawnSeconds: 105, travelSeconds: [40] }),
    camp({ id: 'fort-e', label: 'Turret east', type: 'special', bearing: 'e', position: { x: 0.61, y: 0.58 }, firstSpawnSeconds: 60, respawnSeconds: 105, travelSeconds: [40] }),
