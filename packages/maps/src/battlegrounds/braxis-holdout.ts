 ...
 * beacons is only the first half, so the outcome says "Zerg cleared" — tapping at the
...
export const braxisHoldout: MapDefinition = {
  ...
  camps: [
    camp({ id: 'hellbat-ne', label: 'Hellbats north-east', type: 'siege', bearing: 'ne', position: { x: 0.564, y: 0.352 }, firstSpawnSeconds: 60, respawnSeconds: 90, travelSeconds: [35] }),
    camp({ id: 'hellbat-sw', label: 'Hellbats south-west', type: 'siege', bearing: 'sw', position: { x: 0.372, y: 0.619 }, firstSpawnSeconds: 60, respawnSeconds: 90, travelSeconds: [35] }),
    camp({ id: 'raven-nw', label: 'Raven north-west', type: 'bruiser', bearing: 'nw', position: { x: 0.353, y: 0.389 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [35] }),
    camp({ id: 'raven-se', label: 'Raven south-east', type: 'bruiser', bearing: 'se', position: { x: 0.59, y: 0.574 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [35] }),
