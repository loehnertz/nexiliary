...
export const blackheartsBay: MapDefinition = {
  ...
  camps: [
    camp({ id: 'doubloon-s', label: 'doubloons s', type: 'special', bearing: 's', firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
    camp({ id: 'doubloon-n', label: 'doubloons n', type: 'special', bearing: 'n', firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
    ...
    camp({ id: 'golem', label: 'boss', type: 'boss', bearing: 'n', firstSpawnSeconds: 300, respawnSeconds: 300, travelSeconds: [60] }),
  ],
}
