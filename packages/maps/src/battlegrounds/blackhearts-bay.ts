...
export const blackheartsBay: MapDefinition = {
  ...
  camps: [
    camp({ id: 'doubloon-s', label: 'doubloons s', type: 'special', bearing: 's', position: { x: 0.5, y: 0.5 }, firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
    camp({ id: 'doubloon-n', label: 'doubloons n', type: 'special', bearing: 'n', position: { x: 0.5, y: 0.5 }, firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
