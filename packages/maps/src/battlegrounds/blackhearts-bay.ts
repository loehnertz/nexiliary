...
export const blackheartsBay: MapDefinition = {
  ...
  camps: [
    camp({ id: 'doubloon-s', label: 'doubloons s', type: 'special', firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
    camp({ id: 'doubloon-n', label: 'doubloons n', type: 'special', firstSpawnSeconds: 60, respawnSeconds: 150, travelSeconds: [40] }),
