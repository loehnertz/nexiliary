...
export const towersOfDoom: MapDefinition = {
  ...
  camps: [
    camp({
      ...
      label: 'sappers n',
      type: 'siege',
      bearing: 'n', position: { x: 0.5, y: 0.5 },
    ...
    camp({ id: 'horseman', label: 'boss', type: 'boss', bearing: 'c', position: { x: 0.5, y: 0.5 }, firstSpawnSeconds: 300, respawnSeconds: 300, travelSeconds: [50] }),
  ],
}
