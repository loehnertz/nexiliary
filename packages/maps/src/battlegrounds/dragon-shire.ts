...
export const dragonShire: MapDefinition = {
  ...
  camps: [
    camp({ id: 'siege-w', label: 'Siege west', type: 'siege', bearing: 'w', position: { x: 0.405, y: 0.615 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [45] }),
    camp({ id: 'siege-e', label: 'Siege east', type: 'siege', bearing: 'e', position: { x: 0.6, y: 0.615 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [45] }),
    camp({ id: 'knight-s', label: 'Knights south', type: 'bruiser', bearing: 's', position: { x: 0.5, y: 0.86 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [40] }),
    camp({ id: 'knight-w', label: 'Knights west', type: 'bruiser', bearing: 'w', position: { x: 0.405, y: 0.42 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [40] }),
    camp({ id: 'knight-e', label: 'Knights east', type: 'bruiser', bearing: 'e', position: { x: 0.6, y: 0.42 }, firstSpawnSeconds: 60, respawnSeconds: 240, travelSeconds: [40] }),
  ],
}
