...
export const hauntedMines: MapDefinition = {
  ...
  camps: [
    camp({ id: 'siege-w', label: 'Siege west', type: 'siege', bearing: 'w', position: { x: 0.32, y: 0.425 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [40] }),
    camp({ id: 'siege-e', label: 'Siege east', type: 'siege', bearing: 'e', position: { x: 0.61, y: 0.499 }, firstSpawnSeconds: 60, respawnSeconds: 180, travelSeconds: [40] }),
    camp({ id: 'sapper-n', label: 'Sappers north', type: 'siege', bearing: 'n', position: { x: 0.49, y: 0.314 }, firstSpawnSeconds: 60, respawnSeconds: 120, travelSeconds: [35] }),
    camp({ id: 'sapper-s', label: 'Sappers south', type: 'siege', bearing: 's', position: { x: 0.485, y: 0.626 }, firstSpawnSeconds: 60, respawnSeconds: 120, travelSeconds: [35] }),
  ],
}
